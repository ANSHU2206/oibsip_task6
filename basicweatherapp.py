...
class Weather(Tk):
    ...
    def __gui(self):
        ...
        self.search_textbox = Entry(textvariable=self.search, font=("Segoe UI", 14, 'bold'), width=24, justify="center",
                                    relief="flat")
        ...
        Button(text='Exit', font=("Georgia", 16, "bold"), bg='orange', fg='black', width=7, relief='groove',
               command=self.exit).place(x=680, y=420)
        Button(text='Reset', font=("Georgia", 16, "bold"), bg='orange', fg='black', width=7, relief='groove',
               activebackground="blue", activeforeground='white', command=self.clear).place(x=560, y=420)
    ...
    def __set_information(self, weather):
        ...
        if weather['cod'] == '404' and weather['message'] == 'city not found':
            ...
            self.pressure['text'] = weather['main']['pressure'], 'hPa'
